...
namespace PASAROperations.Models
{
    ...
    public partial class VWCF_CVForm_CycleDetail
    {
        ...
        public int CountTuyereBlock { get; set; }
        public int CountFoamover { get; set; }
        public double SumFSF_Matte { get; set; }
        public double SumGross_Blister { get; set; }
